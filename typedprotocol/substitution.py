...
class TypeVarSubstitutor:
    ...
    @staticmethod
    def build_substitutions(protocol_cls: type) -> dict[typing.TypeVar, typing.TypeVar]:
        """Build TypeVar substitution mapping from generic inheritance."""
        substitutions: dict[typing.TypeVar, typing.TypeVar] = {}
                ...
                if origin and args and hasattr(origin, '__parameters__'):
                    ...
                    if len(params) == len(args):
                        for p, a in zip(params, args):
                            if isinstance(p, typing.TypeVar) and isinstance(a, typing.TypeVar):
                                substitutions[p] = a
        
        return substitutions

    @staticmethod
    def substitute(type_annotation: typing.Any, 
                  substitutions: dict[typing.TypeVar, typing.TypeVar]) -> typing.Any:
...
class SubstitutedMethod:
    ...
    def __init__(self, original_method: typing.Callable[..., typing.Any], 
                 substituted_annotations: dict[str, typing.Any]) -> None:
        self.__annotations__: dict[str, typing.Any] = substituted_annotations
        self._original_method: typing.Callable[..., typing.Any] = original_method
    ...
    def __call__(self, *args: typing.Any, **kwargs: typing.Any) -> typing.Any:
        return self._original_method(*args, **kwargs) if callable(self._original_method) else None